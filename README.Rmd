...
[![Build Status](https://travis-ci.org/Nowosad/rgeopat2.png?branch=master)](https://travis-ci.org/Nowosad/rgeopat2)
...
The goal of `rgeopat2` is to enhance the functionality of [geoPAT 2](http://sil.uc.edu/cms/index.php?id=geopat2).
